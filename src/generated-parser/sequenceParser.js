...
var literalNames = [ null, "':'", "'->'", "'@'", "'||'", "'&&'", "'=='", 
                     ...
                     "'*'", "'/'", "'%'", "'^'", "'!'", "';'", "','", "'='", 
                     "'('", "')'", "'{'", "'}'", "'true'", "'false'", "'nil'", 
                     "'if'", "'else'", null, "'return'", "'new'", "'Starter'", 
                     "'Theme'", "'.'" ];

var symbolicNames = [ null, "COL", "ARROW", "AT", "OR", "AND", "EQ", "NEQ", 
                      "GT", "LT", "GTEQ", "LTEQ", "PLUS", "MINUS", "MULT", 
                      "DIV", "MOD", "POW", "NOT", "SCOL", "COMMA", "ASSIGN", 
                      "OPAR", "CPAR", "OBRACE", "CBRACE", "TRUE", "FALSE", 
                      "NIL", "IF", "ELSE", "WHILE", "RETURN", "NEW", "STARTER_LXR", 
                      "THEME_LXR", "DOT", "ID", "INT", "FLOAT", "STRING", 
                      "CR", "SPACE", "COMMENT", "OTHER", "EVENT_PAYLOAD_LXR", 
                      "EVENT_END", "WS" ];

var ruleNames =  [ "prog", "starterExp", "starter", "participant", "name", 
                   "width", "block", "ret", "value", "stat", "anonymousBlock", 
...
sequenceParser.ARROW = 2;
sequenceParser.AT = 3;
sequenceParser.OR = 4;
sequenceParser.AND = 5;
sequenceParser.EQ = 6;
sequenceParser.NEQ = 7;
sequenceParser.GT = 8;
sequenceParser.LT = 9;
sequenceParser.GTEQ = 10;
sequenceParser.LTEQ = 11;
sequenceParser.PLUS = 12;
sequenceParser.MINUS = 13;
sequenceParser.MULT = 14;
sequenceParser.DIV = 15;
sequenceParser.MOD = 16;
sequenceParser.POW = 17;
sequenceParser.NOT = 18;
sequenceParser.SCOL = 19;
sequenceParser.COMMA = 20;
sequenceParser.ASSIGN = 21;
sequenceParser.OPAR = 22;
sequenceParser.CPAR = 23;
sequenceParser.OBRACE = 24;
sequenceParser.CBRACE = 25;
sequenceParser.TRUE = 26;
sequenceParser.FALSE = 27;
sequenceParser.NIL = 28;
sequenceParser.IF = 29;
sequenceParser.ELSE = 30;
sequenceParser.WHILE = 31;
sequenceParser.RETURN = 32;
sequenceParser.NEW = 33;
sequenceParser.STARTER_LXR = 34;
sequenceParser.THEME_LXR = 35;
sequenceParser.DOT = 36;
sequenceParser.ID = 37;
sequenceParser.INT = 38;
sequenceParser.FLOAT = 39;
sequenceParser.STRING = 40;
sequenceParser.CR = 41;
sequenceParser.SPACE = 42;
sequenceParser.COMMENT = 43;
sequenceParser.OTHER = 44;
sequenceParser.EVENT_PAYLOAD_LXR = 45;
sequenceParser.EVENT_END = 46;
sequenceParser.WS = 47;
...
sequenceParser.RULE_anonymousBlock = 10;
sequenceParser.RULE_creation = 11;
sequenceParser.RULE_message = 12;
sequenceParser.RULE_func = 13;
sequenceParser.RULE_from = 14;
sequenceParser.RULE_signature = 15;
sequenceParser.RULE_invocation = 16;
sequenceParser.RULE_assignment = 17;
sequenceParser.RULE_asyncMessage = 18;
sequenceParser.RULE_content = 19;
sequenceParser.RULE_source = 20;
sequenceParser.RULE_target = 21;
sequenceParser.RULE_constructor = 22;
sequenceParser.RULE_type = 23;
sequenceParser.RULE_assignee = 24;
sequenceParser.RULE_to = 25;
sequenceParser.RULE_methodName = 26;
sequenceParser.RULE_parameters = 27;
sequenceParser.RULE_parameter = 28;
sequenceParser.RULE_declaration = 29;
sequenceParser.RULE_alt = 30;
sequenceParser.RULE_ifBlock = 31;
sequenceParser.RULE_elseIfBlock = 32;
sequenceParser.RULE_elseBlock = 33;
sequenceParser.RULE_braceBlock = 34;
sequenceParser.RULE_loop = 35;
sequenceParser.RULE_expr = 36;
sequenceParser.RULE_atom = 37;
sequenceParser.RULE_parExpr = 38;
...
sequenceParser.prototype.anonymousBlock = function() {
    ...
    this.enterRule(localctx, 20, sequenceParser.RULE_anonymousBlock);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 153;
        this.braceBlock();
...
sequenceParser.prototype.creation = function() {
    ...
    this.enterRule(localctx, 22, sequenceParser.RULE_creation);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 156;
        ...
        if(la_===1) {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if(((((_la - 13)) & ~0x1f) == 0 && ((1 << (_la - 13)) & ((1 << (sequenceParser.MINUS - 13)) | (1 << (sequenceParser.NOT - 13)) | (1 << (sequenceParser.TRUE - 13)) | (1 << (sequenceParser.FALSE - 13)) | (1 << (sequenceParser.NIL - 13)) | (1 << (sequenceParser.NEW - 13)) | (1 << (sequenceParser.ID - 13)) | (1 << (sequenceParser.INT - 13)) | (1 << (sequenceParser.FLOAT - 13)) | (1 << (sequenceParser.STRING - 13)))) !== 0)) {
                this.state = 161;
                this.parameters();
            }
...
sequenceParser.prototype.message = function() {
    ...
    this.enterRule(localctx, 24, sequenceParser.RULE_message);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 172;
        this._errHandler.sync(this);
...
sequenceParser.prototype.func = function() {
    ...
    this.enterRule(localctx, 26, sequenceParser.RULE_func);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 192;
        this._errHandler.sync(this);
...
sequenceParser.prototype.from = function() {
    ...
    this.enterRule(localctx, 28, sequenceParser.RULE_from);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 201;
        this.match(sequenceParser.ID);
...
sequenceParser.prototype.signature = function() {
    ...
    this.enterRule(localctx, 30, sequenceParser.RULE_signature);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 203;
        this.methodName();
...
sequenceParser.prototype.invocation = function() {
    ...
    this.enterRule(localctx, 32, sequenceParser.RULE_invocation);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 207;
...
sequenceParser.prototype.assignment = function() {
    ...
    this.enterRule(localctx, 34, sequenceParser.RULE_assignment);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 214;
        this._errHandler.sync(this);
...
sequenceParser.prototype.asyncMessage = function() {
    ...
    this.enterRule(localctx, 36, sequenceParser.RULE_asyncMessage);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 222;
        this._errHandler.sync(this);
...
sequenceParser.prototype.content = function() {
    ...
    this.enterRule(localctx, 38, sequenceParser.RULE_content);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 228;
...
sequenceParser.prototype.source = function() {
    ...
    this.enterRule(localctx, 40, sequenceParser.RULE_source);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 232;
        this.match(sequenceParser.ID);
...
sequenceParser.prototype.target = function() {
    ...
    this.enterRule(localctx, 42, sequenceParser.RULE_target);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 234;
...
sequenceParser.prototype.constructor = function() {
    ...
    this.enterRule(localctx, 44, sequenceParser.RULE_constructor);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 236;
        this.match(sequenceParser.ID);
...
sequenceParser.prototype.type = function() {
    ...
    this.enterRule(localctx, 46, sequenceParser.RULE_type);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 238;
        this.match(sequenceParser.ID);
...
sequenceParser.prototype.assignee = function() {
    ...
    this.enterRule(localctx, 48, sequenceParser.RULE_assignee);
    var _la = 0; // Token type
    try {
        this.state = 249;
        this._errHandler.sync(this);
...
sequenceParser.prototype.methodName = function() {
    ...
    this.enterRule(localctx, 52, sequenceParser.RULE_methodName);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 253;
...
sequenceParser.prototype.parameters = function() {
    ...
    this.enterRule(localctx, 54, sequenceParser.RULE_parameters);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 255;
...
sequenceParser.prototype.parameter = function() {
    ...
    this.enterRule(localctx, 56, sequenceParser.RULE_parameter);
    try {
        this.state = 268;
        this._errHandler.sync(this);
...
sequenceParser.prototype.declaration = function() {
    ...
    this.enterRule(localctx, 58, sequenceParser.RULE_declaration);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 270;
        this.type();
...
sequenceParser.prototype.alt = function() {
    ...
    this.enterRule(localctx, 60, sequenceParser.RULE_alt);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 273;
...
sequenceParser.prototype.ifBlock = function() {
    ...
    this.enterRule(localctx, 62, sequenceParser.RULE_ifBlock);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 283;
...
sequenceParser.prototype.elseIfBlock = function() {
    ...
    this.enterRule(localctx, 64, sequenceParser.RULE_elseIfBlock);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 287;
...
sequenceParser.prototype.elseBlock = function() {
    ...
    this.enterRule(localctx, 66, sequenceParser.RULE_elseBlock);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 292;
        this.match(sequenceParser.ELSE);
...
sequenceParser.prototype.braceBlock = function() {
    ...
    this.enterRule(localctx, 68, sequenceParser.RULE_braceBlock);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 295;
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(((((_la - 24)) & ~0x1f) == 0 && ((1 << (_la - 24)) & ((1 << (sequenceParser.OBRACE - 24)) | (1 << (sequenceParser.IF - 24)) | (1 << (sequenceParser.WHILE - 24)) | (1 << (sequenceParser.RETURN - 24)) | (1 << (sequenceParser.NEW - 24)) | (1 << (sequenceParser.ID - 24)) | (1 << (sequenceParser.STRING - 24)) | (1 << (sequenceParser.CR - 24)) | (1 << (sequenceParser.OTHER - 24)))) !== 0)) {
            this.state = 296;
            this.block();
        }
...
sequenceParser.prototype.loop = function() {
    ...
    this.enterRule(localctx, 70, sequenceParser.RULE_loop);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 301;
...
sequenceParser.prototype.expr = function(_p) {
    ...
    var _startState = 72;
    this.enterRecursionRule(localctx, 72, sequenceParser.RULE_expr, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 313;
...
sequenceParser.prototype.atom = function() {
    ...
    this.enterRule(localctx, 74, sequenceParser.RULE_atom);
    var _la = 0; // Token type
    try {
        this.state = 346;
        this._errHandler.sync(this);
...
sequenceParser.prototype.parExpr = function() {
    ...
    this.enterRule(localctx, 76, sequenceParser.RULE_parExpr);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 348;
        this.match(sequenceParser.OPAR);
