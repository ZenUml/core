...
var symbolicNames = [ null, "COL", "SOPEN", "SCLOSE", "ARROW", "AT", "OR", 
                      ...
                      "DATABASE", "ENTITY", "QUEUE", "EC2", "ECS", "IAM", 
                      "LAMBDA", "RDS", "S3", "DOT", "ID", "INT", "FLOAT", 
                      "STRING", "CR", "SPACE", "COMMENT", "OTHER", "EVENT_PAYLOAD_LXR", 
                      "EVENT_END", "WS" ];

var ruleNames =  [ "prog", "head", "group", "starterExp", "starter", "participant", 
                   "stereotype", "label", "participantType", "name", "width", 
                   "block", "ret", "stat", "par", "opt", "creation", "creationBody", 
                   "message", "messageBody", "func", "from", "signature", 
                   "invocation", "assignment", "asyncMessage", "content", 
                   "source", "target", "construct", "type", "assignee", 
...
sequenceParser.EC2 = 49;
sequenceParser.ECS = 50;
sequenceParser.IAM = 51;
sequenceParser.LAMBDA = 52;
sequenceParser.RDS = 53;
sequenceParser.S3 = 54;
...
sequenceParser.RULE_creation = 16;
sequenceParser.RULE_creationBody = 17;
sequenceParser.RULE_message = 18;
sequenceParser.RULE_messageBody = 19;
sequenceParser.RULE_func = 20;
sequenceParser.RULE_from = 21;
sequenceParser.RULE_signature = 22;
sequenceParser.RULE_invocation = 23;
sequenceParser.RULE_assignment = 24;
sequenceParser.RULE_asyncMessage = 25;
sequenceParser.RULE_content = 26;
sequenceParser.RULE_source = 27;
sequenceParser.RULE_target = 28;
sequenceParser.RULE_construct = 29;
sequenceParser.RULE_type = 30;
sequenceParser.RULE_assignee = 31;
sequenceParser.RULE_to = 32;
...
sequenceParser.RULE_alt = 37;
sequenceParser.RULE_ifBlock = 38;
sequenceParser.RULE_elseIfBlock = 39;
sequenceParser.RULE_elseBlock = 40;
sequenceParser.RULE_braceBlock = 41;
sequenceParser.RULE_loop = 42;
sequenceParser.RULE_expr = 43;
sequenceParser.RULE_atom = 44;
sequenceParser.RULE_parExpr = 45;
sequenceParser.RULE_condition = 46;
        ...
        case 1:
            ...
            do {
            	...
            	case 1:
            		...
            		case sequenceParser.EC2:
            		case sequenceParser.ECS:
            		case sequenceParser.IAM:
            		case sequenceParser.LAMBDA:
            		case sequenceParser.RDS:
            		case sequenceParser.S3:
...
sequenceParser.prototype.group = function() {
    ...
    try {
        ...
        case 1:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while(_la===sequenceParser.SOPEN || _la===sequenceParser.LT || ((((_la - 42)) & ~0x1f) == 0 && ((1 << (_la - 42)) & ((1 << (sequenceParser.ACTOR - 42)) | (1 << (sequenceParser.BOUNDARY - 42)) | (1 << (sequenceParser.COLLECTION - 42)) | (1 << (sequenceParser.CONTROL - 42)) | (1 << (sequenceParser.DATABASE - 42)) | (1 << (sequenceParser.ENTITY - 42)) | (1 << (sequenceParser.QUEUE - 42)) | (1 << (sequenceParser.EC2 - 42)) | (1 << (sequenceParser.ECS - 42)) | (1 << (sequenceParser.IAM - 42)) | (1 << (sequenceParser.LAMBDA - 42)) | (1 << (sequenceParser.RDS - 42)) | (1 << (sequenceParser.S3 - 42)) | (1 << (sequenceParser.ID - 42)) | (1 << (sequenceParser.STRING - 42)))) !== 0)) {
                this.state = 127;
                this.participant();
                this.state = 132;
                this._errHandler.sync(this);
...
sequenceParser.prototype.participant = function() {
    ...
    try {
        ...
        case 1:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if(((((_la - 42)) & ~0x1f) == 0 && ((1 << (_la - 42)) & ((1 << (sequenceParser.ACTOR - 42)) | (1 << (sequenceParser.BOUNDARY - 42)) | (1 << (sequenceParser.COLLECTION - 42)) | (1 << (sequenceParser.CONTROL - 42)) | (1 << (sequenceParser.DATABASE - 42)) | (1 << (sequenceParser.ENTITY - 42)) | (1 << (sequenceParser.QUEUE - 42)) | (1 << (sequenceParser.EC2 - 42)) | (1 << (sequenceParser.ECS - 42)) | (1 << (sequenceParser.IAM - 42)) | (1 << (sequenceParser.LAMBDA - 42)) | (1 << (sequenceParser.RDS - 42)) | (1 << (sequenceParser.S3 - 42)))) !== 0)) {
                this.state = 161;
...
ParticipantTypeContext.prototype.EC2 = function() {
    return this.getToken(sequenceParser.EC2, 0);
};

ParticipantTypeContext.prototype.ECS = function() {
    return this.getToken(sequenceParser.ECS, 0);
};

ParticipantTypeContext.prototype.IAM = function() {
    return this.getToken(sequenceParser.IAM, 0);
};
...
ParticipantTypeContext.prototype.RDS = function() {
    return this.getToken(sequenceParser.RDS, 0);
};

ParticipantTypeContext.prototype.S3 = function() {
    return this.getToken(sequenceParser.S3, 0);
};
...
sequenceParser.prototype.block = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << sequenceParser.TRUE) | (1 << sequenceParser.FALSE) | (1 << sequenceParser.NIL) | (1 << sequenceParser.IF))) !== 0) || ((((_la - 33)) & ~0x1f) == 0 && ((1 << (_la - 33)) & ((1 << (sequenceParser.WHILE - 33)) | (1 << (sequenceParser.RETURN - 33)) | (1 << (sequenceParser.NEW - 33)) | (1 << (sequenceParser.PAR - 33)) | (1 << (sequenceParser.OPT - 33)) | (1 << (sequenceParser.ID - 33)) | (1 << (sequenceParser.INT - 33)) | (1 << (sequenceParser.FLOAT - 33)) | (1 << (sequenceParser.STRING - 33)) | (1 << (sequenceParser.OTHER - 33)))) !== 0));
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
sequenceParser.prototype.creation = function() {
    ...
    this.enterRule(localctx, 32, sequenceParser.RULE_creation);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 243;
        this.creationBody();
...
sequenceParser.prototype.creationBody = function() {
    ...
    this.enterRule(localctx, 34, sequenceParser.RULE_creationBody);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 249;
...
sequenceParser.prototype.messageBody = function() {
    ...
    this.enterRule(localctx, 38, sequenceParser.RULE_messageBody);
    try {
        this.state = 275;
        this._errHandler.sync(this);
...
sequenceParser.prototype.func = function() {
    ...
    this.enterRule(localctx, 40, sequenceParser.RULE_func);
    try {
        this.state = 293;
        this._errHandler.sync(this);
...
sequenceParser.prototype.from = function() {
    ...
    this.enterRule(localctx, 42, sequenceParser.RULE_from);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 295;
...
sequenceParser.prototype.signature = function() {
    ...
    this.enterRule(localctx, 44, sequenceParser.RULE_signature);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 297;
        this.methodName();
...
sequenceParser.prototype.invocation = function() {
    ...
    this.enterRule(localctx, 46, sequenceParser.RULE_invocation);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 301;
...
sequenceParser.prototype.assignment = function() {
    ...
    this.enterRule(localctx, 48, sequenceParser.RULE_assignment);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 308;
        this._errHandler.sync(this);
...
sequenceParser.prototype.asyncMessage = function() {
    ...
    this.enterRule(localctx, 50, sequenceParser.RULE_asyncMessage);
    try {
        this.state = 335;
        this._errHandler.sync(this);
...
sequenceParser.prototype.content = function() {
    ...
    this.enterRule(localctx, 52, sequenceParser.RULE_content);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 337;
...
sequenceParser.prototype.source = function() {
    ...
    this.enterRule(localctx, 54, sequenceParser.RULE_source);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 339;
...
sequenceParser.prototype.target = function() {
    ...
    this.enterRule(localctx, 56, sequenceParser.RULE_target);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 341;
...
sequenceParser.prototype.to = function() {
    ...
    this.enterRule(localctx, 64, sequenceParser.RULE_to);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 359;
...
sequenceParser.prototype.alt = function() {
    ...
    this.enterRule(localctx, 74, sequenceParser.RULE_alt);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 381;
...
sequenceParser.prototype.ifBlock = function() {
    ...
    this.enterRule(localctx, 76, sequenceParser.RULE_ifBlock);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 391;
...
sequenceParser.prototype.elseIfBlock = function() {
    ...
    this.enterRule(localctx, 78, sequenceParser.RULE_elseIfBlock);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 395;
...
sequenceParser.prototype.elseBlock = function() {
    ...
    this.enterRule(localctx, 80, sequenceParser.RULE_elseBlock);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 400;
        this.match(sequenceParser.ELSE);
...
sequenceParser.prototype.braceBlock = function() {
    ...
    this.enterRule(localctx, 82, sequenceParser.RULE_braceBlock);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 403;
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << sequenceParser.TRUE) | (1 << sequenceParser.FALSE) | (1 << sequenceParser.NIL) | (1 << sequenceParser.IF))) !== 0) || ((((_la - 33)) & ~0x1f) == 0 && ((1 << (_la - 33)) & ((1 << (sequenceParser.WHILE - 33)) | (1 << (sequenceParser.RETURN - 33)) | (1 << (sequenceParser.NEW - 33)) | (1 << (sequenceParser.PAR - 33)) | (1 << (sequenceParser.OPT - 33)) | (1 << (sequenceParser.ID - 33)) | (1 << (sequenceParser.INT - 33)) | (1 << (sequenceParser.FLOAT - 33)) | (1 << (sequenceParser.STRING - 33)) | (1 << (sequenceParser.OTHER - 33)))) !== 0)) {
            this.state = 404;
            this.block();
        }
...
sequenceParser.prototype.loop = function() {
    ...
    this.enterRule(localctx, 84, sequenceParser.RULE_loop);
    try {
        this.state = 416;
        this._errHandler.sync(this);
...
sequenceParser.prototype.expr = function(_p) {
    ...
    var _startState = 86;
    this.enterRecursionRule(localctx, 86, sequenceParser.RULE_expr, _p);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 426;
...
sequenceParser.prototype.atom = function() {
    ...
    this.enterRule(localctx, 88, sequenceParser.RULE_atom);
    var _la = 0; // Token type
    try {
        this.state = 459;
        this._errHandler.sync(this);
...
sequenceParser.prototype.parExpr = function() {
    ...
    this.enterRule(localctx, 90, sequenceParser.RULE_parExpr);
    try {
        this.state = 470;
        this._errHandler.sync(this);
...
sequenceParser.prototype.condition = function() {
    ...
    this.enterRule(localctx, 92, sequenceParser.RULE_condition);
    try {
        this.state = 474;
        this._errHandler.sync(this);
