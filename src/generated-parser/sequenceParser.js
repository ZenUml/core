...
var symbolicNames = [ null, "COL", "SOPEN", "SCLOSE", "ARROW", "AT", "OR", 
                      ...
                      "NEW", "PAR", "GROUP", "OPT", "AS", "STARTER_LXR", 
...
sequenceParser.STARTER_LXR = 40;
sequenceParser.ANNOTATION_RET = 41;
sequenceParser.ANNOTATION = 42;
sequenceParser.DOT = 43;
sequenceParser.ID = 44;
sequenceParser.INT = 45;
sequenceParser.FLOAT = 46;
sequenceParser.STRING = 47;
sequenceParser.CR = 48;
sequenceParser.SPACE = 49;
sequenceParser.COMMENT = 50;
sequenceParser.OTHER = 51;
sequenceParser.EVENT_PAYLOAD_LXR = 52;
sequenceParser.EVENT_END = 53;
sequenceParser.WS = 54;
...
sequenceParser.prototype.group = function() {
    ...
    try {
        ...
        case 1:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while(_la===sequenceParser.SOPEN || _la===sequenceParser.LT || ((((_la - 42)) & ~0x1f) == 0 && ((1 << (_la - 42)) & ((1 << (sequenceParser.ANNOTATION - 42)) | (1 << (sequenceParser.ID - 42)) | (1 << (sequenceParser.STRING - 42)))) !== 0)) {
                this.state = 127;
                this.participant();
                this.state = 132;
                this._errHandler.sync(this);
...
sequenceParser.prototype.block = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(((((_la - 28)) & ~0x1f) == 0 && ((1 << (_la - 28)) & ((1 << (sequenceParser.TRUE - 28)) | (1 << (sequenceParser.FALSE - 28)) | (1 << (sequenceParser.NIL - 28)) | (1 << (sequenceParser.IF - 28)) | (1 << (sequenceParser.WHILE - 28)) | (1 << (sequenceParser.RETURN - 28)) | (1 << (sequenceParser.NEW - 28)) | (1 << (sequenceParser.PAR - 28)) | (1 << (sequenceParser.OPT - 28)) | (1 << (sequenceParser.ANNOTATION_RET - 28)) | (1 << (sequenceParser.ID - 28)) | (1 << (sequenceParser.INT - 28)) | (1 << (sequenceParser.FLOAT - 28)) | (1 << (sequenceParser.STRING - 28)) | (1 << (sequenceParser.OTHER - 28)))) !== 0));
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
sequenceParser.prototype.braceBlock = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(((((_la - 28)) & ~0x1f) == 0 && ((1 << (_la - 28)) & ((1 << (sequenceParser.TRUE - 28)) | (1 << (sequenceParser.FALSE - 28)) | (1 << (sequenceParser.NIL - 28)) | (1 << (sequenceParser.IF - 28)) | (1 << (sequenceParser.WHILE - 28)) | (1 << (sequenceParser.RETURN - 28)) | (1 << (sequenceParser.NEW - 28)) | (1 << (sequenceParser.PAR - 28)) | (1 << (sequenceParser.OPT - 28)) | (1 << (sequenceParser.ANNOTATION_RET - 28)) | (1 << (sequenceParser.ID - 28)) | (1 << (sequenceParser.INT - 28)) | (1 << (sequenceParser.FLOAT - 28)) | (1 << (sequenceParser.STRING - 28)) | (1 << (sequenceParser.OTHER - 28)))) !== 0)) {
            this.state = 409;
            this.block();
        }
