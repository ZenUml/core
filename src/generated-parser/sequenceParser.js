...
var literalNames = [ null, "'const'", "'readonly'", "'static'", "'async'", 
                     "'await'", "'override'", "'void'", "'title'", "':'", 
                     "'<<'", "'>>'", "'->'", null, "'||'", "'&&'", "'=='", 
                     "'!='", "'>'", "'<'", "'>='", "'<='", "'+'", "'-'", 
                     "'*'", "'/'", "'%'", "'^'", "'!'", "';'", "','", "'='", 
                     "'('", "')'", "'{'", "'}'", "'true'", "'false'", null, 
                     "'if'", "'else'", null, "'return'", "'new'", "'par'", 
                     "'group'", "'opt'", "'as'", "'try'", "'catch'", "'finally'", 
                     "'in'", null, null, null, "'.'" ];

var symbolicNames = [ null, "CONSTANT", "READONLY", "STATIC", "ASYNC", "AWAIT", 
                      "OVERRIDE", "VOID", "TITLE", "COL", "SOPEN", "SCLOSE", 
                      "ARROW", "COLOR", "OR", "AND", "EQ", "NEQ", "GT", 
                      "LT", "GTEQ", "LTEQ", "PLUS", "MINUS", "MULT", "DIV", 
                      "MOD", "POW", "NOT", "SCOL", "COMMA", "ASSIGN", "OPAR", 
                      "CPAR", "OBRACE", "CBRACE", "TRUE", "FALSE", "NIL", 
                      "IF", "ELSE", "WHILE", "RETURN", "NEW", "PAR", "GROUP", 
...
sequenceParser.CONSTANT = 1;
sequenceParser.READONLY = 2;
sequenceParser.STATIC = 3;
sequenceParser.ASYNC = 4;
sequenceParser.AWAIT = 5;
sequenceParser.OVERRIDE = 6;
sequenceParser.VOID = 7;
sequenceParser.TITLE = 8;
sequenceParser.COL = 9;
sequenceParser.SOPEN = 10;
sequenceParser.SCLOSE = 11;
sequenceParser.ARROW = 12;
sequenceParser.COLOR = 13;
sequenceParser.OR = 14;
sequenceParser.AND = 15;
sequenceParser.EQ = 16;
sequenceParser.NEQ = 17;
sequenceParser.GT = 18;
sequenceParser.LT = 19;
sequenceParser.GTEQ = 20;
sequenceParser.LTEQ = 21;
sequenceParser.PLUS = 22;
sequenceParser.MINUS = 23;
sequenceParser.MULT = 24;
sequenceParser.DIV = 25;
sequenceParser.MOD = 26;
sequenceParser.POW = 27;
sequenceParser.NOT = 28;
sequenceParser.SCOL = 29;
sequenceParser.COMMA = 30;
sequenceParser.ASSIGN = 31;
sequenceParser.OPAR = 32;
sequenceParser.CPAR = 33;
sequenceParser.OBRACE = 34;
sequenceParser.CBRACE = 35;
sequenceParser.TRUE = 36;
sequenceParser.FALSE = 37;
sequenceParser.NIL = 38;
sequenceParser.IF = 39;
sequenceParser.ELSE = 40;
sequenceParser.WHILE = 41;
sequenceParser.RETURN = 42;
sequenceParser.NEW = 43;
sequenceParser.PAR = 44;
sequenceParser.GROUP = 45;
sequenceParser.OPT = 46;
...
sequenceParser.prototype.group = function() {
    ...
    try {
        ...
        case 1:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while(_la===sequenceParser.SOPEN || _la===sequenceParser.LT || ((((_la - 54)) & ~0x1f) == 0 && ((1 << (_la - 54)) & ((1 << (sequenceParser.ANNOTATION - 54)) | (1 << (sequenceParser.ID - 54)) | (1 << (sequenceParser.STRING - 54)))) !== 0)) {
                this.state = 151;
                this.participant();
                this.state = 156;
                this._errHandler.sync(this);
...
sequenceParser.prototype.block = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while(_la===sequenceParser.EQ || ((((_la - 36)) & ~0x1f) == 0 && ((1 << (_la - 36)) & ((1 << (sequenceParser.TRUE - 36)) | (1 << (sequenceParser.FALSE - 36)) | (1 << (sequenceParser.NIL - 36)) | (1 << (sequenceParser.IF - 36)) | (1 << (sequenceParser.WHILE - 36)) | (1 << (sequenceParser.RETURN - 36)) | (1 << (sequenceParser.NEW - 36)) | (1 << (sequenceParser.PAR - 36)) | (1 << (sequenceParser.OPT - 36)) | (1 << (sequenceParser.TRY - 36)) | (1 << (sequenceParser.ANNOTATION_RET - 36)) | (1 << (sequenceParser.ID - 36)) | (1 << (sequenceParser.INT - 36)) | (1 << (sequenceParser.FLOAT - 36)) | (1 << (sequenceParser.STRING - 36)) | (1 << (sequenceParser.OTHER - 36)))) !== 0));
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
sequenceParser.prototype.creationBody = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(((((_la - 36)) & ~0x1f) == 0 && ((1 << (_la - 36)) & ((1 << (sequenceParser.TRUE - 36)) | (1 << (sequenceParser.FALSE - 36)) | (1 << (sequenceParser.NIL - 36)) | (1 << (sequenceParser.ID - 36)) | (1 << (sequenceParser.INT - 36)) | (1 << (sequenceParser.FLOAT - 36)) | (1 << (sequenceParser.STRING - 36)))) !== 0)) {
            this.state = 294;
            this.assignment();
        }
        ...
        if(la_===1) {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if(_la===sequenceParser.MINUS || _la===sequenceParser.NOT || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (sequenceParser.OPAR - 32)) | (1 << (sequenceParser.TRUE - 32)) | (1 << (sequenceParser.FALSE - 32)) | (1 << (sequenceParser.NIL - 32)) | (1 << (sequenceParser.NEW - 32)) | (1 << (sequenceParser.ID - 32)) | (1 << (sequenceParser.INT - 32)) | (1 << (sequenceParser.FLOAT - 32)) | (1 << (sequenceParser.STRING - 32)))) !== 0)) {
                this.state = 300;
                this.parameters();
            }
...
sequenceParser.prototype.braceBlock = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(_la===sequenceParser.EQ || ((((_la - 36)) & ~0x1f) == 0 && ((1 << (_la - 36)) & ((1 << (sequenceParser.TRUE - 36)) | (1 << (sequenceParser.FALSE - 36)) | (1 << (sequenceParser.NIL - 36)) | (1 << (sequenceParser.IF - 36)) | (1 << (sequenceParser.WHILE - 36)) | (1 << (sequenceParser.RETURN - 36)) | (1 << (sequenceParser.NEW - 36)) | (1 << (sequenceParser.PAR - 36)) | (1 << (sequenceParser.OPT - 36)) | (1 << (sequenceParser.TRY - 36)) | (1 << (sequenceParser.ANNOTATION_RET - 36)) | (1 << (sequenceParser.ID - 36)) | (1 << (sequenceParser.INT - 36)) | (1 << (sequenceParser.FLOAT - 36)) | (1 << (sequenceParser.STRING - 36)) | (1 << (sequenceParser.OTHER - 36)))) !== 0)) {
            this.state = 463;
            this.block();
        }
