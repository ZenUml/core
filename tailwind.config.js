    ...
    extend: {
      textColor: {
        skin: {
          ...
          comment: 'var(--color-text-comment, var(--color-text-base, #000))',
          fragment: 'var(--color-text-fragment, var(--color-text-message, #000))',
          base: 'var(--color-text-base)',
          header: 'var(--color-text-header)',
          secondary: 'var(--color-text-secondary)',
          control: 'var(--color-text-control, var(--color-text-base, #000))',
          muted: 'var(--color-text-muted)',
          hover: 'var(--color-text-hover)',
          link: `var(--color-text-link, var(--color-text-base, #000))`,
      ...
      backgroundColor: {
        skin: {
          ...
          "fragment-header": 'var(--color-bg-fragment-header, var(--color-bg-participant, var(--color-bg-frame, var(--color-bg-canvas, var(--color-bg-base, #fff)))))',
